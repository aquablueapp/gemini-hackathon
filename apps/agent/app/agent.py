...
root_agent = Agent(
    ...
    instruction=(
        ...
        "- Output Links: When presenting Google Slides links in chat responses, always output them as standard URLs (e.g. `https://docs.google.com/presentation/d/...`). The frontend will automatically convert them into a premium button.\n"
